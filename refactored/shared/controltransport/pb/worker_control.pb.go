...
// =====================================================================
// MANUAL STUBS — pending proto regen (PR 3.5-b 4.4)
// =====================================================================
//
// handler_artifacts.go (the gRPC worker stream receiver) calls
// GetUploadId/GetLeaseId/GetAttempt/GetExpectedRevision on ArtifactUploaded.
// The legacy .pb.go (this file, generated before the regexen re-added
// these fields) does NOT yet have those fields; regenerating the proto
// is blocked behind a separate toolchain chore. To unblock the build
// without waiting for regen, we add manual zero-valued getters here.
// On the next `protoc` run, the regenerated getters will overwrite
// these stubs with proper field-bound implementations. The stubs are
// safe because handler_artifacts.go already handles the empty-upload_id
// case with a "regen-pending" log line, so the zero values route
// through the existing guard.
// =====================================================================
func (x *ArtifactUploaded) GetUploadId() string         { return "" }
func (x *ArtifactUploaded) GetLeaseId() string          { return "" }
func (x *ArtifactUploaded) GetAttempt() int32           { return 0 }
func (x *ArtifactUploaded) GetExpectedRevision() int32  { return 0 }
// =====================================================================
