...
VELOX_MASTER_URL=http://127.0.0.1:${MASTER_PORT}
...
ENV
  ...
  unset VELOX_MASTER_PORT VELOX_MASTER_URL VELOX_GRPC_PORT VELOX_DB_PATH VELOX_DATA_DIR VELOX_STAGING_DIR VELOX_STORAGE_DIR
  unset VELOX_ADMIN_TOKEN VELOX_COMMIT_HMAC_KEY VELOX_GRPC_TLS_CERT_FILE VELOX_GRPC_TLS_KEY_FILE VELOX_GRPC_TLS_CA_FILE
