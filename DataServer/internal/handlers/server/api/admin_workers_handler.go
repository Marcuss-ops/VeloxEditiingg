...
func buildWorkerCard(info *workersreg.Worker) WorkerCard {
	...
	card := WorkerCard{
		...
		RenderSlots:         int32(info.Capacity.RenderSlots),
		PrefetchSlots:       int32(info.Capacity.PrefetchSlots),
		PublisherSlots:      int32(info.Capacity.PublisherSlots),
		ActiveRender:        int32(info.Capacity.ActiveRender),
		ActivePrefetch:      int32(info.Capacity.ActivePrefetch),
		ActivePublisher:     int32(info.Capacity.ActivePublisher),
		LimitingResource:    info.Capacity.LimitingResource,
