...
func TestStatusIsTerminal(t *testing.T) {
	...
	// StatusTimedOut is a Task terminal state (the reaper's atomic
	...
	if StatusTimedOut.IsTerminal() != true {
		t.Errorf("StatusTimedOut.IsTerminal()=%v; want true", StatusTimedOut.IsTerminal())
	}
	...
	if !foundTimedOut {
		t.Errorf("AllStatuses() missing StatusTimedOut")
	}
}
