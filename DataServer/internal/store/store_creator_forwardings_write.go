...
// store_creator_forwardings_write.go owns the creator_forwardings write
// paths: the idempotent insert and the payload upsert (CAS-guarded on a
// leasable status). Read paths live in store_creator_forwardings_query.go.
