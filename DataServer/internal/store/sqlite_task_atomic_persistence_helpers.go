...
// sqlite_task_atomic_persistence_helpers.go contains the write helpers used
// by IngestTaskResultAtomic. Each helper receives the coordinator-owned
// transaction; none opens, commits, or rolls back a transaction.
