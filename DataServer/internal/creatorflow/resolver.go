...
//
// The payload/spec map conversions (preparePayloadWithControlPlaneDelivery,
// clonePublicationSpecs, publicationSpecToMap, publicationMetadataToMap,
// clonePublicationValue, cloneControlPlaneMap) live in the sibling file
// resolver_spec_maps.go.
package creatorflow
