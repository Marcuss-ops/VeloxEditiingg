...
type Definition struct { Name, Metric, Window string; Target float64; Comparator string }
...
func Meets(def Definition, observed float64) bool { if def.Comparator == ">=" { return observed >= def.Target }; return observed <= def.Target }
