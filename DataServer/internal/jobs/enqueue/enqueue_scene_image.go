...
func BuildSceneImagePayload(rawPayload map[string]interface{}, dataDir, videosDir string, resolvers ...DriveFolderResolver) (map[string]interface{}, error) {
	return BuildSceneImagePayloadForMaster(rawPayload, dataDir, videosDir, "", resolvers...)
}
...
func BuildSceneImagePayloadForMaster(rawPayload map[string]interface{}, dataDir, videosDir, masterURL string, resolvers ...DriveFolderResolver) (map[string]interface{}, error) {
	var resolver DriveFolderResolver
	if len(resolvers) > 0 {
		resolver = resolvers[0]
	}
	return buildSceneImagePayload(rawPayload, dataDir, videosDir, masterURL, resolver)
}

func buildSceneImagePayload(rawPayload map[string]interface{}, dataDir, videosDir, masterURL string, resolver DriveFolderResolver) (map[string]interface{}, error) {
