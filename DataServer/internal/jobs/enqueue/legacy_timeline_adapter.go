// Package enqueue — legacy timeline compatibility adapter.
//
// This file owns only the compatibility projection that reconstructs
// legacy items/clips/clip_link/video_mode and related tracks from the
// canonical scene timeline.
package enqueue
