...
const file_velox_control_worker_control_proto_rawDesc = "" +
	"\n" +
	"\"velox/control/worker_control.proto\x12\rvelox.control\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x8b\t\n" +
	...
	"\x17asset_download_progress\x18$ \x01(\v2$.velox.control.AssetDownloadProgressH\x00R\x15assetDownloadProgressB\x05\n" +
	...
	"\x13transfer_generation\x18\x1b \x01(\x03R\x12transferGeneration\"\xc3\t\n" +
...
var file_velox_control_worker_control_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_velox_control_worker_control_proto_goTypes = []any{
	...
	(*OutputManifest)(nil),            // 33: velox.control.OutputManifest
	(*UploadTarget)(nil),              // 34: velox.control.UploadTarget
	(*TaskOutputDeclared)(nil),        // 35: velox.control.TaskOutputDeclared
	(*ArtifactUploadPlan)(nil),        // 36: velox.control.ArtifactUploadPlan
	(*ArtifactUploadCompleted)(nil),   // 37: velox.control.ArtifactUploadCompleted
	(*TaskCommitAck)(nil),             // 38: velox.control.TaskCommitAck
	(*TaskResultAck)(nil),             // 39: velox.control.TaskResultAck
	(*TaskExecutionMetrics)(nil),      // 40: velox.control.TaskExecutionMetrics
	(*WorkerResourceCounters)(nil),    // 41: velox.control.WorkerResourceCounters
	(*timestamppb.Timestamp)(nil),     // 42: google.protobuf.Timestamp
	(*structpb.Struct)(nil),           // 43: google.protobuf.Struct
}
var file_velox_control_worker_control_proto_depIdxs = []int32{
	42, // 0: velox.control.WorkerToMasterEnvelope.sent_at:type_name -> google.protobuf.Timestamp
	...
	35, // 10: velox.control.WorkerToMasterEnvelope.task_output_declared:type_name -> velox.control.TaskOutputDeclared
	37, // 11: velox.control.WorkerToMasterEnvelope.artifact_upload_completed:type_name -> velox.control.ArtifactUploadCompleted
	15, // 12: velox.control.WorkerToMasterEnvelope.asset_download_progress:type_name -> velox.control.AssetDownloadProgress
	43, // 13: velox.control.Hello.capabilities:type_name -> google.protobuf.Struct
	43, // 14: velox.control.Heartbeat.extra:type_name -> google.protobuf.Struct
	41, // 15: velox.control.Heartbeat.resources:type_name -> velox.control.WorkerResourceCounters
	40, // 16: velox.control.TaskResult.execution_metrics:type_name -> velox.control.TaskExecutionMetrics
	10, // 17: velox.control.TaskResult.phase_markers:type_name -> velox.control.PhaseMarker
	43, // 18: velox.control.TaskResult.output_artifacts:type_name -> google.protobuf.Struct
	4,  // 19: velox.control.TaskResult.segment_timings:type_name -> velox.control.SegmentTiming
	11, // 20: velox.control.TaskResult.partial_phase_metrics:type_name -> velox.control.PhaseTimingDetailed
	11, // 21: velox.control.TaskResult.phase_timings:type_name -> velox.control.PhaseTimingDetailed
	7,  // 22: velox.control.TaskResult.waterfall:type_name -> velox.control.AttemptWaterfallStage
	8,  // 23: velox.control.TaskResult.milestones:type_name -> velox.control.AttemptMilestone
	6,  // 24: velox.control.TaskResult.asset_preparation:type_name -> velox.control.AssetPreparationBreakdown
	42, // 25: velox.control.AttemptWaterfallStage.started_at:type_name -> google.protobuf.Timestamp
	42, // 26: velox.control.AttemptWaterfallStage.completed_at:type_name -> google.protobuf.Timestamp
	42, // 27: velox.control.TaskLeaseRenewal.requested_expiry:type_name -> google.protobuf.Timestamp
	42, // 28: velox.control.PhaseMarker.started_at:type_name -> google.protobuf.Timestamp
	42, // 29: velox.control.PhaseMarker.completed_at:type_name -> google.protobuf.Timestamp
	42, // 30: velox.control.PhaseTimingDetailed.started_at:type_name -> google.protobuf.Timestamp
	42, // 31: velox.control.PhaseTimingDetailed.completed_at:type_name -> google.protobuf.Timestamp
	14, // 32: velox.control.AssetDownloadProgress.job_refs:type_name -> velox.control.AssetJobReference
	42, // 33: velox.control.MasterToWorkerEnvelope.sent_at:type_name -> google.protobuf.Timestamp
	17, // 34: velox.control.MasterToWorkerEnvelope.hello_ack:type_name -> velox.control.HelloAck
	18, // 35: velox.control.MasterToWorkerEnvelope.task_offer:type_name -> velox.control.TaskOffer
	21, // 36: velox.control.MasterToWorkerEnvelope.task_lease_granted:type_name -> velox.control.TaskLeaseGranted
	22, // 37: velox.control.MasterToWorkerEnvelope.command:type_name -> velox.control.Command
	23, // 38: velox.control.MasterToWorkerEnvelope.cancel_job:type_name -> velox.control.CancelJob
	24, // 39: velox.control.MasterToWorkerEnvelope.drain:type_name -> velox.control.Drain
	25, // 40: velox.control.MasterToWorkerEnvelope.configuration_update:type_name -> velox.control.ConfigurationUpdate
	26, // 41: velox.control.MasterToWorkerEnvelope.lease_revoked:type_name -> velox.control.LeaseRevoked
	27, // 42: velox.control.MasterToWorkerEnvelope.ping:type_name -> velox.control.Ping
	36, // 43: velox.control.MasterToWorkerEnvelope.artifact_upload_plan:type_name -> velox.control.ArtifactUploadPlan
	38, // 44: velox.control.MasterToWorkerEnvelope.task_commit_ack:type_name -> velox.control.TaskCommitAck
	39, // 45: velox.control.MasterToWorkerEnvelope.task_result_ack:type_name -> velox.control.TaskResultAck
	28, // 46: velox.control.MasterToWorkerEnvelope.future_asset_plan:type_name -> velox.control.FutureAssetPlan
	32, // 47: velox.control.MasterToWorkerEnvelope.cancel_prefetch:type_name -> velox.control.CancelPrefetch
	43, // 48: velox.control.TaskOffer.task_spec:type_name -> google.protobuf.Struct
	42, // 49: velox.control.TaskOffer.lease_deadline:type_name -> google.protobuf.Timestamp
	43, // 50: velox.control.TaskOffer.requirements:type_name -> google.protobuf.Struct
	43, // 51: velox.control.TaskOffer.output_contract:type_name -> google.protobuf.Struct
	42, // 52: velox.control.Command.timestamp:type_name -> google.protobuf.Timestamp
	43, // 53: velox.control.Command.params:type_name -> google.protobuf.Struct
	43, // 54: velox.control.ConfigurationUpdate.configuration:type_name -> google.protobuf.Struct
	42, // 55: velox.control.FutureAssetPlan.generated_at:type_name -> google.protobuf.Timestamp
	42, // 56: velox.control.FutureAssetPlan.expires_at:type_name -> google.protobuf.Timestamp
	29, // 57: velox.control.FutureAssetPlan.prefetch_jobs:type_name -> velox.control.PrefetchJob
	31, // 58: velox.control.FutureAssetPlan.protect_assets:type_name -> velox.control.ProtectedFutureAsset
	30, // 59: velox.control.PrefetchJob.assets:type_name -> velox.control.PrefetchAsset
	33, // 60: velox.control.TaskOutputDeclared.manifests:type_name -> velox.control.OutputManifest
	34, // 61: velox.control.ArtifactUploadPlan.targets:type_name -> velox.control.UploadTarget
	42, // 62: velox.control.TaskCommitAck.committed_at:type_name -> google.protobuf.Timestamp
	42, // 63: velox.control.WorkerResourceCounters.sampled_at:type_name -> google.protobuf.Timestamp
