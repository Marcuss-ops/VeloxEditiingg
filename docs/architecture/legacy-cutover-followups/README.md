...
| [PR-13](./PR-13-verify-job-reaper-post-048.md) | [P0.4](../LEGACY_SSOT_AUDIT.md#p04--lease-task-senza-expiry-persistita) effetti 048 | Verify & fix Job-side reaper post-048 (DEPRECATED by PR-05 follow-up) | PR-11, prima di PR-05 | ✅ merged and retired; TaskLeaseReaper is the canonical master-side lease enforcer; DisableReaper + DisableReaper/ReaperDisabled/RequeueExpiredLeasesSafe and the zombie-reaper goroutine were removed |
