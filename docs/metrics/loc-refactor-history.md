...
Triage was reverted per § 19.7; actual fix tracked at `docs/issues/2026-07-17-testgeneratorimages-creator-stage-pre-existing.md` (owner: enqueue+creatorflow, two-stage 404→canonical-purity cascade).
