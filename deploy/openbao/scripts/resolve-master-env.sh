...
#   VELOX_SOCIAL_API_TIMEOUT_MS=30000  VELOX_SOCIAL_API_RETRIES=3
...
VELOX_SOCIAL_API_RETRIES="${VELOX_SOCIAL_API_RETRIES:-3}"
...

{
    ...
    render SOCIAL_API_RETRIES "$VELOX_SOCIAL_API_RETRIES"
