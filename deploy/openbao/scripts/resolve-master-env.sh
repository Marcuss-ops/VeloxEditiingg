...
#   VELOX_SMOKE_ASSET_ID (required for production Level-D smoke gates)
...
VELOX_TASKGRAPH_TICK="${VELOX_TASKGRAPH_TICK:-100ms}"
...
VELOX_SMOKE_ASSET_ID="${VELOX_SMOKE_ASSET_ID:-}"
VELOX_SMOKE_MODE="${VELOX_SMOKE_MODE:-}"
...

{
    ...
    render VELOX_DB_MAX_OPEN_CONNS "$VELOX_DB_MAX_OPEN_CONNS"
    render VELOX_DB_MAX_IDLE_CONNS "$VELOX_DB_MAX_IDLE_CONNS"
    ...
    render VELOX_SMOKE_MODE "$VELOX_SMOKE_MODE"
